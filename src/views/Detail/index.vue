...
<style scoped>
#detailContrainer{position: absolute;left: 0;top: 0;z-index: 100;width: 100%;height: 100%;background: #fff;}
.slide-enter-active{animation: 1s slideMove;}
@keyframes slideMove{
